...
class HexagonalLocator extends OctagonalLocator
{
	...
	public function hasIntersection(Island $island, Island $other): bool {
		if (parent::hasIntersection($island, $other)) {
			return true;
		}
		//TODO
		return false;
	...
	protected function lookForNeighbour(Coordinates $coordinates, Island $island): ?Region {
	...
	protected function addTouchingRegion(Coordinates $coordinates, Island $island): ?Region {
